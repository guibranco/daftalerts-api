...
public static class PropertyMappings
{
    ...
    public static string ToStatusString(this PropertyStatus s) =>
        s switch
        {
    ...
    public static PropertyStatus ParseStatusString(string? s) =>
        (s ?? string.Empty).ToLowerInvariant() switch
        {
...
{
    public static FilterPresetDto ToDto(this FilterPreset f) =>
        new(
            f.Id,
            f.Name,
            f.RoutingKeys,
